...
import com.ssmy.cuddle.databinding.ItemCustomTabBinding
...
class CustomTabAdapter(
...
) : RecyclerView.Adapter<CustomTabAdapter.ViewHolder>() {

    var selectedPosition = 0

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemCustomTabBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class ViewHolder(private val binding: ItemCustomTabBinding) : RecyclerView.ViewHolder(binding.root) {
